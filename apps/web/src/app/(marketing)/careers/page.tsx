...
export default function CareersPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-20">
      <Reveal>
        <h1 className="font-display text-4xl font-semibold tracking-tight text-foreground">Careers</h1>
      ...
      <Reveal delay={100}>
        <p className="mt-4 text-muted-foreground">
          ...
          <a href="mailto:careers@sutram.app" className="text-primary underline underline-offset-2 hover:text-primary/80">
            careers@sutram.app
          </a>{" "}
