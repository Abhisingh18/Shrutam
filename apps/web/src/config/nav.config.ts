...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Admissions", href: "/app/admissions", icon: ClipboardList, requiredPermission: "admissions:application:read", phase: 1, implemented: false },
  { label: "Students", href: "/app/students", icon: GraduationCap, requiredPermission: "students:profile:read", phase: 1, implemented: true },
  { label: "Faculty", href: "/app/faculty", icon: Users, requiredPermission: "faculty:profile:read", phase: 1, implemented: false },
  { label: "Academics", href: "/app/academics", icon: BookOpen, requiredPermission: "courses:catalog:read", phase: 1, implemented: false },
  { label: "Attendance", href: "/app/attendance", icon: CalendarCheck, requiredPermission: "attendance:record:read", phase: 1, implemented: false },
  { label: "Examinations", href: "/app/examinations", icon: FileCheck2, requiredPermission: "exams:schedule:read", phase: 1, implemented: false },
  { label: "Fees & Finance", href: "/app/finance", icon: Wallet, requiredPermission: "fees:invoice:read", phase: 1, implemented: false },
